...
template <typename _CharT, typename _Traits, typename _Alloc>
_GLIBCXX20_CONSTEXPR void basic_string<_CharT, _Traits, _Alloc>::swap(
    basic_string &__s) _GLIBCXX_NOEXCEPT {
...
_GLIBCXX20_CONSTEXPR void basic_string<_CharT, _Traits, _Alloc>::_M_construct(
...
basic_string<_CharT, _Traits, _Alloc>::_M_construct(size_type __n, _CharT __c) {
...
template <typename _CharT, typename _Traits, typename _Alloc>
_GLIBCXX20_CONSTEXPR void basic_string<_CharT, _Traits, _Alloc>::_M_mutate(
...
template <typename _CharT, typename _Traits, typename _Alloc>
_GLIBCXX20_CONSTEXPR void
basic_string<_CharT, _Traits, _Alloc>::_M_erase(size_type __pos,
                                                size_type __n) {
...
template <typename _CharT, typename _Traits, typename _Alloc>
_GLIBCXX20_CONSTEXPR basic_string<_CharT, _Traits, _Alloc> &
...
_GLIBCXX20_CONSTEXPR basic_string<_CharT, _Traits, _Alloc> &
basic_string<_CharT, _Traits, _Alloc>::_M_replace_dispatch(const_iterator __i1,
                                                           const_iterator __i2,
                                                           _InputIterator __k1,
                                                           _InputIterator __k2,
                                                           std::__false_type) {
...
template <typename _CharT, typename _Traits, typename _Alloc>
_GLIBCXX20_CONSTEXPR basic_string<_CharT, _Traits, _Alloc> &
basic_string<_CharT, _Traits, _Alloc>::_M_replace(size_type __pos,
                                                  size_type __len1,
                                                  const _CharT *__s,
...
constexpr void
basic_string<_CharT, _Traits, _Alloc>::resize_and_overwrite(const size_type __n,
                                                            _Operation __op) {
  const size_type __capacity = capacity();
  _CharT *__p;
  if (__n > __capacity) {
  ...
  if (__cerb) {
    __try {
      ...
      while (__extracted < __n && !_Traits::eq_int_type(__c, __eof) &&
             !__is_whitespace_patched_assumes_utf8_thisisbad(
...
extern template void basic_string<char>::_M_replace_cold(char *, size_type,
                                                         const char *,
                                                         const size_type,
                                                         const size_type);
#endif
